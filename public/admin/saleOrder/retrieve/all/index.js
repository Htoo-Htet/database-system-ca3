window.addEventListener('DOMContentLoaded', function () {
    ...
    const quantityInputs = document.querySelector(".quantity");
    quantityInputs.addEventListener("input", function () {
        this.value = this.value.replace(/[^0-9]/g, "");
    });

    const priceInputs = document.querySelector(".price");
    priceInputs.addEventListener("input", function () {
        this.value = this.value.replace(/[^0-9.]/g, "");
    });
